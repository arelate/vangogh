...
namespace GOG.Models
{
    ...
    public class Price
    {
        ...
        [DataMember(Name = "baseAmount")] public string BaseAmount { get; set; }
        [DataMember(Name = "finalAmount")] public string FinalAmount { get; set; }
        ...
        [DataMember(Name = "isFree")] public bool IsFree { get; set; }
        [DataMember(Name = "discount")] public double Discount { get; set; }
