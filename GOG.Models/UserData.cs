...
namespace GOG.Models
{
    ...
    public class UserData
    {
        ...
        [DataMember(Name = "ratingBrand")] public string RatingBrand { get; set; }
        [DataMember(Name = "isLoggedIn")] public bool IsLoggedIn { get; set; }
        [DataMember(Name = "checksum")] public Checksum Checksum { get; set; }
        [DataMember(Name = "updates")] public Updates Updates { get; set; }
