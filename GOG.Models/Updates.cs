...
namespace GOG.Models
{
    ...
    {
        [DataMember(Name = "messages")] public int Messages { get; set; }
        ...
        [DataMember(Name = "products")] public int Products { get; set; }
        [DataMember(Name = "forum")] public int Forum { get; set; }
