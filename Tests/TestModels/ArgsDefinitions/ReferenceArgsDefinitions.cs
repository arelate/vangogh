        ...
        public static ArgsDefinition ArgsDefinition { get; set; } = new ArgsDefinition() 
        {
            ...
            Methods = new Method[] {
                ...
                new Method() {
                    Title = "update",
                    Order = 20,
                    Collections = new string[] { "products", "gameproductdata", "accountproducts", "apiproducts", "gamedetails", "updated", "wishlisted", "screenshots" },
            ...
            Dependencies = new Dependency[] {
                new Dependency() {
                    Method = "update",
                    Collections = new string[] { "accountproducts", "apiproducts", "gamedetails", "updated", "wishlisted" },
