...
// Auth username on GOG.com for account data queries
func Auth(client *http.Client, username, password string) error {
	...
	loginAuthURL := authURL(loginHost)
