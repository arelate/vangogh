...
namespace GoodOfflineGames
{
    class LegacyProgram
    {
        ...
        //{
            ...
            //IReportUpdateDelegate reportUpdateDelegate = new Progrss(consoleController);
            ...
            //if (!authorizationController.Authorize(settings.Authenticate).Result)
            //{
            ...
            //consoleController.Write("Requesting new products from {0}...", ConsoleColor.White, Uris.Paths.Games.AjaxFiltered);
            ...
            //consoleController.Write("Requesting new products from {0}...", ConsoleColor.White, Uris.Paths.Account.GetFilteredProducts);
            ...
            //var wishlistedString = gogDataController.GetString(Uris.Paths.Account.Wishlist).Result;
            ...
            //consoleController.WriteLine("Updating game details, product files and cleaning up product folders...", MessageType.Progress);
            ...
            //var updatedProducts = (settings.Update.Everything) ?
            //    new List<long>(owned.Count) :
            //    new List<long>(updated);

            //if (settings.Update.Everything)
            ...
            //                updatedGameDetails,
            //                settings.Download.Languages,
            //                settings.Download.OperatingSystems).Result;
            //    }

            //    if (settings.Validate.AfterDownload)
            //    {
            ...
            //        if (settings.Cleanup.AfterDownload)
            //        {
