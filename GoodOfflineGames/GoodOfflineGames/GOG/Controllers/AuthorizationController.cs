...
namespace GOG.Controllers
{
    public class AuthorizationController : IAuthorizationController
    {
        ...
        public async Task<bool> Authorize(ICredentials credentials)
        {
            ...
            string loginToken = ExtractToken(authResponse);
            ...
            else
            {
                if (loginCheckResult.Contains("second_step_authentication_token_letter"))
                {
                    ...
                    var twoStepToken = ExtractToken(loginCheckResult);
                    ...
                    string twoStepData = uriController.CombineQueryParameters(QueryParameters.TwoStepAuthenticate);

                    var twoStepLoginCheckResult = await stringNetworkController.PostString(Urls.TwoStep, null, twoStepData);
