...
{
    public class ConsoleRequestPresentController : IRequestPresentController<string, string[]>
    {
        private int savedCursorTopPosition = -1;

        private int remainingPreviousFrameLines = 0;

        //private int currentFrameContentLines = 0;
        //private int currentFramePaddingLines = 0;
        ...
        public void InitializeNewPresentation()
        {
        ...
        public void PresentFragment(params string[] lines)
        {
        ...
        public Task PresentNewAsync(params string[] data)
        {
            throw new NotImplementedException();
        }
