namespace Models.Dependencies
{
    ...
    {
        public const string JSONSerializationController =
        ...
        public const string JSONSerializedStorageController =
            "Controllers.SerializedStorage.JSON.JSONSerializedStorageController,Controllers";

        public const string ProtoBufSerializedStorageController =
            "Controllers.SerializedStorage.ProtoBuf.ProtoBufSerializedStorageController,Controllers";
