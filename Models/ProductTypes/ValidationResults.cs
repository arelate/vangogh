...
namespace Models.ProductTypes
{
    ...
    public class ChunkValidation : IChunkValidation
    {
        ...
        [DataMember(Name = "expectedHash")] public string ExpectedHash { get; set; }
        [DataMember(Name = "actualHash")] public string ActualHash { get; set; }
    }
    ...
    public class FileValidation : IFileValidationResults
    {
        ...
        [DataMember(Name = "sizeVerified")] public bool SizeVerified { get; set; }
        [DataMember(Name = "chunks")] public IChunkValidation[] Chunks { get; set; }
    }
    ...
    {
        [DataMember(Name = "files")] public IFileValidationResults[] Files { get; set; }
    }
}