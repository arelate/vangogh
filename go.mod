...
require (
	github.com/arelate/vangogh_cli_api v0.4.41
	github.com/arelate/vangogh_local_data v0.2.45
...
require (
	...
	github.com/boggydigital/yt_urls v0.1.18 // indirect
