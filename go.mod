...
require (
	...
	github.com/arelate/vangogh_api v0.1.1
...
require (
	github.com/arelate/gog_auth v0.1.3-alpha // indirect
	github.com/arelate/gog_auth_urls v0.1.2-alpha // indirect
	github.com/arelate/gog_types v0.1.8-alpha // indirect
	github.com/arelate/gog_urls v0.1.9-alpha // indirect
	github.com/arelate/vangogh_sets v0.1.0 // indirect
	github.com/arelate/vangogh_urls v0.1.0-alpha // indirect
	github.com/arelate/vangogh_values v0.1.2-alpha // indirect
	github.com/boggydigital/dolo v0.2.0 // indirect
	github.com/boggydigital/gost v0.1.0 // indirect
	github.com/boggydigital/kvas v0.1.9-alphago // indirect
...
replace (
	...
	github.com/arelate/vangogh_api => ../vangogh_api
