...
func HandleFuncs() {
	...
	patternHandlers := map[string]http.Handler{
		...
		"GET /gog/news/{id}/all":      AuthCookie(sb, Log(http.HandlerFunc(GetGogNews)), perm.ReadProductData),
		...
		"GET /gog/description-image/{relPath...}": AuthCookie(sb, Log(http.HandlerFunc(GetDescriptionImage)), perm.ReadImages),
		// binaries endpoints
		...
		"GET /gog": Redirect("/gog/dispatch", http.StatusPermanentRedirect),
	}
